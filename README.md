...
## Morf 3.2 name nickname syntax

Names now support nickname relationships directly in the name entry line. The first comma-separated unit is the main name pattern; comma-separated units after it are nicknames for that name. Slashes, brackets, and optional parentheses still work as variation syntax.
