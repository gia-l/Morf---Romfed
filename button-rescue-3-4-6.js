/* Morf 3.4.6 pre-app button rescue.
...
(function(){
  ...
  var STORE_KEY = 'morf-3-4-6-compat-settings';
  var lastResults = [];
  var lastStats = {};
  ...
  function doExport(){ var M=core(); if(!M){ status('MorfCore did not load.', 'error'); return false; } var st=readDomIntoState(safeState()); window.__MorfSafeState=st; mutateAppState(st); download('morf-3-4-6-settings.morf', M.exportState(st)); status('Exported settings file.','success'); return false; }
