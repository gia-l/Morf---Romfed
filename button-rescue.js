/* Morf 4.2 pre-app button rescue.
...
(function(){
  ...
  var STORE_KEY = 'morf-4-2-settings';
  var lastResults = [];
  var lastStats = {};
  ...
  function doExport(){ var M=core(); if(!M){ status('MorfCore did not load.', 'error'); return false; } var st=readDomIntoState(safeState()); window.__MorfSafeState=st; mutateAppState(st); download('morf-4-2-settings.morf', M.exportState(st)); status('Exported settings file.','success'); return false; }
